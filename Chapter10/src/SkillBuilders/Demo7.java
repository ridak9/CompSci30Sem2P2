...
public class Demo7 {
	...
	private void initialize() 
	{
		...
		ImageIcon cr = new ImageIcon("../Chapter10/src/can.jpg");
		ImageIcon cw = new ImageIcon("../Chapter10/src/cw.png");
		ImageIcon vk = new ImageIcon("../Chapter10/src/vikings.png");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				...
				else if(schools.getSelectedItem().equals("Ernest Manning"))
				{
